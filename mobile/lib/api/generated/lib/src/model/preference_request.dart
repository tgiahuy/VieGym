...
part 'preference_request.g.dart';
...
class PreferenceRequest {
  /// Returns a new [PreferenceRequest] instance.
  PreferenceRequest({
    this.dislikedFoods,
  ...
  Map<String, dynamic> toJson() => _$PreferenceRequestToJson(this);
