...
class AuthControllerApi {
  ...
  const AuthControllerApi(this._dio);
  ...
  Future<Response<ApiResponseVoid>> changePassword({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<ApiResponseVoid, ApiResponseVoid>(
              rawData,
              'ApiResponseVoid',
              growable: true,
            );
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseRegisterChallengeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseRegisterChallengeResponse>> forgotPassword({
    ...
    ApiResponseRegisterChallengeResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              ApiResponseRegisterChallengeResponse
            >(rawData, 'ApiResponseRegisterChallengeResponse', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiResponseRegisterChallengeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiResponseSessionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSessionResponse>> google({
    ...
    final _path = r'/api/v1/auth/google';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    ApiResponseSessionResponse? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<ApiResponseSessionResponse, ApiResponseSessionResponse>(
              rawData,
    ...
    return Response<ApiResponseSessionResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseSessionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSessionResponse>> login({
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseVoid] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseVoid>> logout({
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseSessionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSessionResponse>> refresh({
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseRegisterChallengeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseRegisterChallengeResponse>> register({
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseRegisterChallengeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseRegisterChallengeResponse>> resendOtp({
    required OtpResendRequest otpResendRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/otp/resend';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      _bodyData = jsonEncode(otpResendRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseVoid] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseVoid>> resetPassword({
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseSessionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseSessionResponse>> verifyOtp({
    ...
    try {
      _bodyData = jsonEncode(otpVerifyRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
