...
class UserProfileControllerApi {
  ...
  const UserProfileControllerApi(this._dio);
  ...
  Future<Response<ApiResponseUserResponse>> callGet({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<ApiResponseUserResponse, ApiResponseUserResponse>(
              rawData,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseUserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseUserResponse>> update({
